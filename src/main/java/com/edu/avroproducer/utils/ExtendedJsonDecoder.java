...
/**
 * A {@link Decoder} for Avro's JSON data encoding. <p> Construct using {@link DecoderFactory}. </p> ExtendedJsonDecoder is not thread-safe.
 * <p> Based on {@link org.apache.avro.io.JsonDecoder JsonDecoder} and <a
 * href="https://jitpack.io/p/Celos/avro-json-decoder">ExtendedJsonDecoder</a>. Infers default arguments, if they are not present. </p>
...
public class ExtendedJsonDecoder extends ParsingDecoder
  ...
  /**
   * <p>Reconfigures this JsonDecoder to use the InputStream provided.</p> <p>If the InputStream provided is null, a NullPointerException is
   * thrown.</p> Otherwise, this JsonDecoder will reset its state and then reconfigure its input.
   * 
  ...
  /**
   * <p>Reconfigures this JsonDecoder to use the String provided for input.</p> <p>If the String provided is null, a NullPointerException is
   * thrown.</p> Otherwise, this JsonDecoder will reset its state and then reconfigure its input.
   * 
