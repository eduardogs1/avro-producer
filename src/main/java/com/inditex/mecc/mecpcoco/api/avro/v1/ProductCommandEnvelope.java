...
public class ProductCommandEnvelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ProductCommandEnvelope> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ProductCommandEnvelope> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ProductCommandEnvelope>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ProductCommandEnvelope to a ByteBuffer.
  ...
  /**
   * Deserializes a ProductCommandEnvelope from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ProductCommandEnvelope instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ProductCommandEnvelope fromByteBuffer(
   ...
   */
  public ProductCommandEnvelope(com.inditex.aqsw.pipe.v1.Metadata metadata, java.lang.Object payload) {
  ...
  /**
   * Creates a new ProductCommandEnvelope RecordBuilder.
   * @return A new ProductCommandEnvelope RecordBuilder
   */
  public static com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder newBuilder() {
    return new com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder();
  }

  /**
   * Creates a new ProductCommandEnvelope RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ProductCommandEnvelope RecordBuilder
   */
  public static com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder newBuilder(com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder other) {
    if (other == null) {
      return new com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder();
    } else {
      return new com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder(other);
    }
  }

  /**
   * Creates a new ProductCommandEnvelope RecordBuilder by copying an existing ProductCommandEnvelope instance.
   * @param other The existing instance to copy.
   * @return A new ProductCommandEnvelope RecordBuilder
   */
  public static com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder newBuilder(com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope other) {
    if (other == null) {
      return new com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder();
    } else {
      return new com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder(other);
  ...
  /**
   * RecordBuilder for ProductCommandEnvelope instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductCommandEnvelope>
    implements org.apache.avro.data.RecordBuilder<ProductCommandEnvelope> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ProductCommandEnvelope instance
     * @param other The existing instance to copy.
     */
    private Builder(com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.metadata)) {
        this.metadata = data().deepCopy(fields()[0].schema(), other.metadata);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder setMetadata(com.inditex.aqsw.pipe.v1.Metadata value) {
     ...
     * @return This builder.
     */
    public com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder setMetadataBuilder(com.inditex.aqsw.pipe.v1.Metadata.Builder value) {
      clearMetadata();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder clearMetadata() {
      metadata = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder setPayload(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.mecpcoco.api.avro.v1.ProductCommandEnvelope.Builder clearPayload() {
      payload = null;
    ...
    public ProductCommandEnvelope build() {
      try {
        ProductCommandEnvelope record = new ProductCommandEnvelope();
        if (metadataBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ProductCommandEnvelope>
    WRITER$ = (org.apache.avro.io.DatumWriter<ProductCommandEnvelope>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ProductCommandEnvelope>
    READER$ = (org.apache.avro.io.DatumReader<ProductCommandEnvelope>)MODEL$.createDatumReader(SCHEMA$);
