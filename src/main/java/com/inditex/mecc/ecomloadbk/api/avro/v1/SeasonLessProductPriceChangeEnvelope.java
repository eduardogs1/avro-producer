...
public class SeasonLessProductPriceChangeEnvelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder newBuilder() {
    return new com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder();
  }
   ...
   * @return A new SeasonLessProductPriceChangeEnvelope RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder(other);
    }
  }
   ...
   * @return A new SeasonLessProductPriceChangeEnvelope RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SeasonLessProductPriceChangeEnvelope>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.metadata)) {
        this.metadata = data().deepCopy(fields()[0].schema(), other.metadata);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder setMetadata(com.inditex.aqsw.pipe.v1.Metadata value) {
     ...
     * @return This builder.
     */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder setMetadataBuilder(com.inditex.aqsw.pipe.v1.Metadata.Builder value) {
      clearMetadata();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder clearMetadata() {
      metadata = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder setPayload(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.SeasonLessProductPriceChangeEnvelope.Builder clearPayload() {
      payload = null;
