...
public class ObservationType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4040423070612423049L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ObservationType\",\"namespace\":\"com.inditex.mecc.ecomloadbk.api.avro.v1\",\"doc\":\"Class that holds observatios/descriptions about a price\",\"fields\":[{\"name\":\"description\",\"type\":\"string\",\"doc\":\"Description of the price info\"},{\"name\":\"kind\",\"type\":{\"type\":\"enum\",\"name\":\"KindTypeEnum\",\"symbols\":[\"REGULAR\",\"SALES\",\"EVENT\"]},\"doc\":\"Enum to catalog the price type\"},{\"name\":\"ecomload_promo_info\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"EcomloadPromoInfoType\",\"doc\":\"Class that holds the reference info\",\"fields\":[{\"name\":\"ecomload_promo_name\",\"type\":\"string\",\"doc\":\"The promo name created by EcomLoad\"},{\"name\":\"ecomload_promo_id\",\"type\":\"long\",\"doc\":\"The eomload promo id\"}]}],\"doc\":\"Ecomload promos data description\",\"default\":null}]}");
  ...
  @Deprecated public com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum kind;
  /** Ecomload promos data description */
  @Deprecated public com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType ecomload_promo_info;
   ...
   */
  public ObservationType(java.lang.CharSequence description, com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum kind, com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType ecomload_promo_info) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: kind = (com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum)value$; break;
    case 2: ecomload_promo_info = (com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum getKind() {
    return kind;
  }
   ...
   * @param value the value to set.
   */
  public void setKind(com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum value) {
    this.kind = value;
  }
   ...
   */
  public com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType getEcomloadPromoInfo() {
   ...
   * @param value the value to set.
   */
  public void setEcomloadPromoInfo(com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType value) {
   ...
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder newBuilder() {
    return new com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder();
  }
   ...
   * @return A new ObservationType RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder(other);
    }
  }
   ...
   * @return A new ObservationType RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ObservationType>
    ...
    /** Enum to catalog the price type */
    private com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum kind;
    /** Ecomload promos data description */
    private com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType ecomload_promo_info;
    private com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.Builder ecomload_promo_infoBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder other) {
      super(other);
      ...
      if (other.hasEcomloadPromoInfoBuilder()) {
        this.ecomload_promo_infoBuilder = com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.newBuilder(other.getEcomloadPromoInfoBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.description)) {
        this.description = data().deepCopy(fields()[0].schema(), other.description);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder setKind(com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder clearKind() {
      kind = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder setEcomloadPromoInfo(com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType value) {
     ...
     * @return This builder.
     */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.Builder getEcomloadPromoInfoBuilder() {
      if (ecomload_promo_infoBuilder == null) {
        if (hasEcomloadPromoInfo()) {
          setEcomloadPromoInfoBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.newBuilder(ecomload_promo_info));
        } else {
          setEcomloadPromoInfoBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder setEcomloadPromoInfoBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.ObservationType.Builder clearEcomloadPromoInfo() {
    ...
    public ObservationType build() {
      try {
        ...
        record.kind = fieldSetFlags()[1] ? this.kind : (com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum) defaultValue(fields()[1]);
        if (ecomload_promo_infoBuilder != null) {
          try {
          ...
          record.ecomload_promo_info = fieldSetFlags()[2] ? this.ecomload_promo_info : (com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.kind = com.inditex.mecc.ecomloadbk.api.avro.v1.KindTypeEnum.values()[in.readEnum()];
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.ecomload_promo_info == null) {
          this.ecomload_promo_info = new com.inditex.mecc.ecomloadbk.api.avro.v1.EcomloadPromoInfoType();
        }
