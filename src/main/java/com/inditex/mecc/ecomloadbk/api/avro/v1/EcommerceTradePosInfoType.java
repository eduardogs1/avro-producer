...
public class EcommerceTradePosInfoType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3338723912873900198L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EcommerceTradePosInfoType\",\"namespace\":\"com.inditex.mecc.ecomloadbk.api.avro.v1\",\"doc\":\"Class that holds the current ecommerce trade info\",\"fields\":[{\"name\":\"tradeposcnId\",\"type\":\"long\",\"doc\":\"Internal ecommerce trade id\"},{\"name\":\"memberId\",\"type\":\"long\",\"doc\":\"Internal member id\"},{\"name\":\"name\",\"type\":\"string\",\"doc\":\"Internal ecommerce trade name\"}]}");
  ...
  @Deprecated public long tradeposcnId;
  /** Internal member id */
  @Deprecated public long memberId;
   ...
   * @param tradeposcnId Internal ecommerce trade id
   * @param memberId Internal member id
   * @param name Internal ecommerce trade name
   */
  public EcommerceTradePosInfoType(java.lang.Long tradeposcnId, java.lang.Long memberId, java.lang.CharSequence name) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: tradeposcnId = (java.lang.Long)value$; break;
  ...
  /**
   * Gets the value of the 'tradeposcnId' field.
  ...
  /**
   * Sets the value of the 'tradeposcnId' field.
   * Internal ecommerce trade id
   * @param value the value to set.
   */
  public void setTradeposcnId(long value) {
    this.tradeposcnId = value;
  }
   ...
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder newBuilder() {
    return new com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder();
  }
   ...
   * @return A new EcommerceTradePosInfoType RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder(other);
    }
  }
   ...
   * @return A new EcommerceTradePosInfoType RecordBuilder
   */
  public static com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder newBuilder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType other) {
    if (other == null) {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder();
    } else {
      return new com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EcommerceTradePosInfoType>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.tradeposcnId)) {
        this.tradeposcnId = data().deepCopy(fields()[0].schema(), other.tradeposcnId);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.tradeposcnId)) {
        this.tradeposcnId = data().deepCopy(fields()[0].schema(), other.tradeposcnId);
    ...
    /**
      * Sets the value of the 'tradeposcnId' field.
      * Internal ecommerce trade id
      * @param value The value of 'tradeposcnId'.
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder setTradeposcnId(long value) {
    ...
    /**
      * Checks whether the 'tradeposcnId' field has been set.
      * Internal ecommerce trade id
      * @return True if the 'tradeposcnId' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'tradeposcnId' field.
      * Internal ecommerce trade id
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder clearTradeposcnId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder setMemberId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder clearMemberId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.inditex.mecc.ecomloadbk.api.avro.v1.EcommerceTradePosInfoType.Builder clearName() {
      name = null;
    ...
    public EcommerceTradePosInfoType build() {
      try {
        ...
        record.tradeposcnId = fieldSetFlags()[0] ? this.tradeposcnId : (java.lang.Long) defaultValue(fields()[0]);
        record.memberId = fieldSetFlags()[1] ? this.memberId : (java.lang.Long) defaultValue(fields()[1]);
  ...
  @Override public void customEncode(org.apache.avro.io.Encoder out)
    throws java.io.IOException
  {
    out.writeLong(this.tradeposcnId);
